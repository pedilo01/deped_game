        ...
        <div class="game-area">
            ...
            <div class="left-panel">
                ...
                <div class="game-buttons" id="gameButtons">
                    ...
                    <button class="game-btn" data-game="mathadventure"
                        onclick="window.location.href='math_adventure.php'">
                ...
                <div style="margin-top: 20px; text-align: center;">
                    <a href="./analytics.php"
                        style="background:#36d1dc; color:white; border:none; padding:10px 20px; border-radius:10px; cursor:pointer; margin-right: 10px;">
